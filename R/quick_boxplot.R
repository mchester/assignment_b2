...
#' @examples
#' quick_boxplot(cancer_sample, diagnosis, perimeter_mean)
#' quick_boxplot(cancer_sample, diagnosis, symmetry_mean)
#' quick_boxplot(cancer_sample, diagnosis, area_mean)
#' @export
